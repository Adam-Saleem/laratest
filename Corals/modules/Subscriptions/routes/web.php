...
use Corals\Modules\Subscriptions\Middleware\CanSubscripeMiddleware;
...
Route::group(['middleware' => [\Corals\Modules\Subscriptions\Middleware\SubscriptionMiddleware::class,
    CanSubscripeMiddleware::class
]], function () {
