...
class UsageManager
{
     ...
     * @throws \Exception
     */
    public function recordAUsage($model, $usageDetails, $product = null, $plan = null, $user = null, $usedValue = 1)
    {
    ...
    public function isFeatureUsageReachedLimit($feature, $subscription = null, $currentCycle = null,)
    {
        ...
        switch ($planFeature->type) {
            case 'quantity':
                $usageCount = $usageQuery->sum('used_value');
     ...
     */
    public function getFeatureUsageQuery($feature, $subscription, $currentCycle)
    {
