...
class SubscriptionsServiceProvider extends BasePackageServiceProvider
{
    protected $defer = true;
    /**
     * @var
     */
    protected $packageCode = 'corals-subscriptions';
    /**
...
//        $this->loadMigrationsFrom(__DIR__ . '/database/migrations');
    ...
    {
        Modules::addModulesPackages('corals/subscriptions');
    }
}
