                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="table color-table table table-hover table-striped table-condensed">
                                                <thead>
                                                <tr class="bg-primary">
                                                ...
                                                @if($plan)
                                                    <tr>
                                                        ...
                                                        <td class="vcenter"><b> <label
                                                                        class="label badge badge-primary label-primary">@lang('Subscriptions::labels.subscription.subscribe')</label>
                                                            </b>
                                                        </td>
                            ...
                            @if($require_payment_step)
                                <div id="select-payment" class="checkoutStep step-3" data-toggle="validator">
                                    ...
                                    @else
                                        ...
                                        <hr>
                                        <div class="">
                                            {!! CoralsForm::radio('gateway','Subscriptions::attributes.subscription.select_payment_method', false,  \Payments::getAvailableGateways()  ) !!}
                                        </div>
                                    ...
                                    <div class="text-right">
                                        {!! CoralsForm::button('Subscriptions::labels.subscription.check_out',['class'=>'btn btn-primary','id'=>'subscription-checkout'], 'submit') !!}
                                        {!! CoralsForm::link(url('dashboard'), 'Corals::labels.cancel',['class'=>'btn btn-warning']) !!}
                                    </div>
